...
export default function Regular_87({ onRegularInput }: { onRegularInput: any }) {
  ...
  return (
    <div className="flex justify-between p-1 bg-slate-400 text-stone-950 rounded-sm">
      <label className="">87-Reg</label>
      <input className=" w-3/4 font-bold" type="number" name="regular" onChange={regularInputHandler} />
    </div>
  )
}