...
export default function Operations({ truckType }: { truckType: any }) {
  return (
    <div className="flex flex-col justify-center items-center m-2 p-2 w-full h-full bg-slate-800 text-slate-800 font-bold rounded-md ">
      <button
        className="flex justify-center m-1 p-1 w-full bg-slate-500 hover:bg-slate-600 rounded-md"
